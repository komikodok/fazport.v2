...
<template>
    <div 
      ref="card"
      class="card transform-3d w-64 h-80 border-[0.1px] border-[#c4b7a7] rounded-xl relative overflow-hidden"
    ...
    > 
      <div 
        ref="cover-card"
        class="absolute inset-0 flex flex-col transition-all"
      >
        <h2 class="title text-2xl text-center text-[#5f5145] p-4 w-full h-28">{{ props.title }}</h2>
        <img 
          :src="props.image"
