...
<template>
  ...
  > 
    ...
    <div 
        ref="content-card"
        class="absolute text-[#5f5145] w-full h-full cursor-pointer border-[0.1px] border-[#c4b7a7] rounded-xl flex flex-col justify-between gap-2 transition-all px-5 py-3"
        :class="[props.openCarousel ? 'drop-shadow-[0_0_30px_#c4b7a7] pointer-events-auto' : 'pointer-events-none']"
        :style="{
          backgroundImage: 'linear-gradient(to top left, #eee7db, #c4b7a5, #eee7db, #eee7db, #eee7db)',
